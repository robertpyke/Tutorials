...
Now, when a user loads the index.html page of your site, they will download the jquery file, and process it is a javascript.
...
* We added test.js to our included scripts.
* We've given our paragraph a new id.
* We've added a button.
* We've created a div, with an inner h3 and p. These have classes which should test out some of jquery-ui elements.
