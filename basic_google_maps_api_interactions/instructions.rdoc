  ...
  <html>
    <head>
      ...
      <script type="text/javascript"
        src="http://maps.googleapis.com/maps/api/js?key=YOUR_API_KEY-Tar7bKnIcY&sensor=SET_TO_TRUE_OR_FALSE">
      </script>
      <script type="text/javascript">
        function initialize() {
          var myOptions = {
...
Put the following code in your move_map_randomly.html file.
  ...
  <html>
    <head>
      ...
      <script type="text/javascript"
        src="http://maps.googleapis.com/maps/api/js?key=AIzaSyAo3TVBlAHxH57sROb2cV_7-Tar7bKnIcY&sensor=false">
      </script>
      <script type="text/javascript">
        var map;
...
Once the map is created, we use the jQuery function +setInterval+ to call the +moveMapRandomly+ every 2 seconds.
